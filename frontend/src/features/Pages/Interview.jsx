                ...
                <nav className='interview-nav'>
                    ...
                    <div className="nav-content">
                        <button 
                            ...
                            onClick={() => navigate('/')}
                        >
                            <div className="interview-nav__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" style={{ marginRight: "0.7rem" }} height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
